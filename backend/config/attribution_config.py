...
class AttributionConfig:
    ...
    alpha = 0.15          # PageRank — Downstream orchestration dominance.
    gamma = 0.15          # Behavioral Anomaly — IsolationForest telemetry fingerprint.
    delta = 0.10          # Normalized Frequency — General activity volume.
